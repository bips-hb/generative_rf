...
adult_res.to_csv("Identity_adult.csv")
...
metric = covtype_metrics, synthesizer = {"Identity": Identity()})
covtype_res.to_csv("Identity_covtype.csv")
# credit
np.random.seed(2022)
torch.manual_seed(2022)
credit_res = scores(data_train = credit_train, data_test = credit_test, list_of_classifiers = credit_classifiers,
metric = credit_metrics, synthesizer = {"Identity": Identity()})
credit_res.to_csv("Identity_credit.csv")
# intrusion
np.random.seed(2022)
torch.manual_seed(2022)
intrusion_res = scores(data_train = intrusion_train, data_test = intrusion_test, list_of_classifiers = intrusion_classifiers,
metric = intrusion_metrics, synthesizer = {"Identity": Identity()})
intrusion_res.to_csv("Identity_intrusion.csv")
# mnist12
np.random.seed(2022)
torch.manual_seed(2022)
mnist12_res = scores(data_train = mnist12_train, data_test = mnist12_test, list_of_classifiers = mnist12_classifiers,
metric = mnist12_metrics, synthesizer = {"Identity": Identity()})
mnist12_res.to_csv("Identity_mnist12.csv")
# mnist28
np.random.seed(2022)
torch.manual_seed(2022)
mnist12_res = scores(data_train = mnist28_train, data_test = mnist28_test, list_of_classifiers = mnist28_classifiers,
metric = mnist28_metrics, synthesizer = {"Identity": Identity()})
mnist28_res.to_csv("Identity_mnist28.csv")
# news 
np.random.seed(2022)
torch.manual_seed(2022)
news_res = scores(data_train = news_train, data_test = news_test, list_of_classifiers = news_classifiers,
metric = news_metrics, synthesizer = {"Identity": Identity()})
news_res.to_csv("Identity_news.csv")